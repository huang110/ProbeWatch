...
export const normalizeNode = (node) => {
  ...
  return {
    ...
    cpuModel: safeText(resource.cpu_model || resource.cpu_name, '—'),
    cpuMhz: numeric(resource.cpu_mhz),
    cpuCores: numeric(resource.cpu_cores) || 1,
    cpuTempC: numeric(resource.cpu_temp_c),
