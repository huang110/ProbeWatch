...
const MOCK_SYSTEM_LOGS = [
  {
    ...
    summary: '管理员更新了 [DMIT 洛杉矶] 的账单资费及流量口径配置',
  ...
  },
  {
    ...
    ip: '198.51.100.88',
    userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/128.0',
    summary: '成功为节点 [Taipei 101] 执行了流量校准 Offset (+28.4 GB)',
    timestamp: Date.now() - 480000,
    payload: {
      action: 'calibrate_traffic',
      node_id: 'tpe-101',
      applied_offset_bytes: 30494261248,
      reason: '对齐 Hinet 商家后台计费已用量',
      operator: 'admin',
    },
  },
  {
  ...
  },
  {
    ...
    summary: '触发网络延迟告警: [腾讯 硅谷] 至 国内联通 探测连续丢包超 15%',
  ...
  },
  {
    ...
    ip: '198.51.100.88',
    userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/128.0',
    summary: '管理员生成了新节点 [牛马云] 的部署指令并分发专属 Token',
